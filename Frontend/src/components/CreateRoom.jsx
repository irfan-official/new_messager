    ...
    <div className="w-full min-h-screen bg-slate-950 flex items-center justify-center text-white">
      <div className="border border-violet-500 rounded-lg p-5 w-6/12 flex flex-col items-center gap-10">
        ...
        >
          ...
          />
          <div className="flex w-[58.5%] items-center justify-between">
            <input
              ...
              placeholder="image"
            />
            <span className="bg-slate-900 rounded-md text-white">
              <select
                name="groupTypes"
                required
                value={groupTypes}
                onChange={(e) => setGroupTypes(e.target.value)}
                className="peer p-2 mt-1 border-b border-violet-500 px-0 py-1  focus:outline-none text-white "
              >
                <option
                  value=""
                  disabled
